...
public class ControllerRequerimientos {
    ...
    public ArrayList<Requerimiento_1> consultaRequerimiento_1(Integer Limit) throws SQLException{
        return this.requerimientoDao_1.requerimiento1(Limit);
    }
    
    public ArrayList<Requerimiento_2> consultaRequerimiento_2(Integer Limit) throws SQLException{
        return this.requerimientoDao_2.requerimiento2(Limit);
    }
    
    public ArrayList<Requerimiento_2> consultaRequerimiento_2(String DateIni, String DateFin, String campoCiudad, Integer Limit) throws SQLException{
        return this.requerimientoDao_2.requerimiento2(DateIni, DateFin, campoCiudad, Limit);
    }
    
    public ArrayList<Requerimiento_3> consultaRequerimiento_3(Integer Limit) throws SQLException{
        return this.requerimientoDao_3.requerimiento3(Limit);
    }
}
