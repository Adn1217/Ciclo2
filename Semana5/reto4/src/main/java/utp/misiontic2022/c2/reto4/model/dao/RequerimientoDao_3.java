...
public class RequerimientoDao_3 {
    ...
    public ArrayList<Requerimiento_3> requerimiento3 (Integer limit) throws SQLException{
        ...
        try{
            ...
            String consulta = "SELECT (SUBSTR(Li.Nombre,1,1) || SUBSTR(Li.Primer_Apellido,1,1) "+
                              "|| SUBSTR(Li.Segundo_Apellido,1,1)) as Abrev FROM Lider as Li";
